...
class P3_LongestSubstringWithoutRepeatingCharacters_HashSet {
    ...
    public static void main(String[] args) {
        P3_LongestSubstringWithoutRepeatingCharacters_HashSet sol = new P3_LongestSubstringWithoutRepeatingCharacters_HashSet();
